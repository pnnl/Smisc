...
##' Sorts a dataframe by one or more variables, ascending or descending.
##' 
##' The order of the arguments \code{form} and \code{dat} is interchangeable.
##' In the formula, use + for ascending, - for decending. Sorting is left to
##' right in the formula.  For example, to sort the dataframe \code{Oats} with
##' sorting variables \code{Block} and \code{Variety}, useage is either of the
##' following:
##' 
##' \code{sort.data.frame(~ Block - Variety, Oats)} or
##' 
...
##' @param dat The dataframe to sort
##' @return The sorted dataframe
##' @author Kevin Wright with ideas from Any Liaw and small edits by Landon
##' Sego
##' @keywords manip
##' @examples
##' 
